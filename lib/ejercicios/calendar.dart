        ...
        children: <Widget>[
          ...
          TableCalendar(
            ...
            calendarStyle: CalendarStyle(
              defaultTextStyle:
                  widget.dateStyle ?? const TextStyle(color: Color.fromARGB(255, 255, 255, 255)),
              weekendTextStyle:
                  widget.dateStyle ?? const TextStyle(color: Color.fromARGB(255, 255, 255, 255)),
              holidayTextStyle:
                  widget.dateStyle ?? const TextStyle(color: Color.fromARGB(255, 255, 255, 255)),
              selectedTextStyle:
                  const TextStyle(color: Color(0xFFFAFAFA), fontSize: 16.0)
                      ,
              todayTextStyle:
                  const TextStyle(color: Color.fromARGB(255, 0, 0, 0), fontSize: 16.0)
                      ,
              outsideTextStyle: const TextStyle(color: Color.fromARGB(255, 255, 255, 255))
                  ,
            ...
            daysOfWeekStyle: DaysOfWeekStyle(
              weekdayStyle: const TextStyle(color: Color.fromARGB(255, 255, 255, 255))
                  ,
              weekendStyle: const TextStyle(color: Color.fromARGB(255, 255, 255, 255))
                  ,
            ),
