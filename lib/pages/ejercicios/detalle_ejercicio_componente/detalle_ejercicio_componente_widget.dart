...
class _DetalleEjercicioComponenteWidgetState
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<EjerciciosRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<EjerciciosRow> containerEjerciciosRowList = snapshot.data!;

        final containerEjerciciosRow = containerEjerciciosRowList.isNotEmpty
            ? containerEjerciciosRowList.first
            : null;
