...
Widget wrapWithModel<T extends GymHubModel>({
  required T model,
...
T createModel<T extends GymHubModel>(
...
abstract class GymHubModel<W extends Widget> {
...
class GymHubDynamicModels<T extends GymHubModel> {
  GymHubDynamicModels(this.defaultBuilder);
