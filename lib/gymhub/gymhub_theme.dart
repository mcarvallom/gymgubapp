...
abstract class GymHubTheme {
  static GymHubTheme of(BuildContext context) {
...
class LightModeTheme extends GymHubTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
  ...
  late Color primary = const Color(0xFF00FFA5);
  late Color secondary = const Color(0xFFF00250);
  late Color tertiary = const Color(0xFF3939C8);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF000000);
  late Color primaryBackground = const Color(0xFF1B1B1E);
  late Color secondaryBackground = const Color(0xFF2C2C2F);
  ...
  late Color lineColor = const Color(0xFFCDCDCD);
}
