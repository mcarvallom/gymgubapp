...
class GHButtonOptions {
  const GHButtonOptions({
    this.textAlign,
    this.textStyle,
    this.elevation,
    this.height,
...
class GHButtonWidget extends StatefulWidget {
  const GHButtonWidget({
    super.key,
    required this.text,
  ...
  final GHButtonOptions options;
  final bool showLoadingIndicator;

  @override
  State<GHButtonWidget> createState() => _GHButtonWidgetState();
}

class _GHButtonWidgetState extends State<GHButtonWidget> {
  bool loading = false;
