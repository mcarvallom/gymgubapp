...
class GymHubIconButton extends StatefulWidget {
  const GymHubIconButton({
    Key? key,
    required this.icon,
    this.borderColor,
    this.borderRadius,
  ...
  @override
  State<GymHubIconButton> createState() => _GymHubIconButtonState();
}

class _GymHubIconButtonState extends State<GymHubIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(GymHubIconButton oldWidget) {
